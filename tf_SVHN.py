...
train_mat, test_mat = loadmat('SVHN/train_32x32.mat'), loadmat('SVHN/test_32x32.mat')
X_train, Y_train = train_mat['X'], train_mat['y']
X_test, Y_test = test_mat['X'], test_mat['y']
# plt.imshow(X_train[:, :, :, 1])
X_train = np.reshape(X_train, (32 * 32 * 3, 73257))
X_test = np.reshape(X_test, (32 * 32 * 3, 26032))
